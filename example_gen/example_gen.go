...
// Generate creates a sample XML snippet for the given element name
func Generate(protoTree []interface{}, elementName string) string {
...
func (g *Generator) generateElement(buf *bytes.Buffer, element *xgen.Element, indent int) {
	...
	if complexType != nil {
		...
		g.generateSimpleTypeContent(buf, element.Type)
	}
